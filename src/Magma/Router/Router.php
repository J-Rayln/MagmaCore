...
class Router implements RouterInterface
{
    ...
    /**
     * Match the route to the routes in teh routing table, setting the
     * $this->params property if a route is found.
     * 
     * @param string $url 
     * @return bool 
     */
     ...
     * within the route parameters only if it was added.
     * 
     * @param string $string 
     * @return string 
     */
