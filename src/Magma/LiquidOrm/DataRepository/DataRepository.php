...
class DataRepository implements DataRepositoryInterface
{
    ...
    {
        if (!is_array($conditions)) throw new DataRepositoryInvalidArgumentException('The argument supplied is not an array.');
    }

    private function isEmpty(int $id): void
    {
        if (empty($id)) throw new DataRepositoryInvalidArgumentException('Argument should not be empty.');
    }
    ...
    {
        // TODO: Implement findObjectBy method in the DataRepository class.
        return $this;
    }
    ...
    {
        // TODO: Implement findWithSearchAndPaging method in the DataRepository class.
        return [];
    }

    public function findAndReturn(int $id, array $selectors = []): DataRepositoryInterface
    {
        // TODO: Implement findAndReturn method in the DataRepository class.
        return $this;
    }
}
